...
<head>
    ...
    <title>Active Rides - WeCycle</title>
            ...
            <nav class="navbar navbar-light">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="activerides.php" class="dropdown-item active"><i class="far fa-file-alt me-2"></i>Active Rides</a>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $qrtActiveRide = "SELECT * FROM tbl_rides WHERE status='On-going'";
                                    $resActiveRide = mysqli_query($conn, $qrtActiveRide);
                                    if(mysqli_num_rows($resActiveRide)>0)
                                    {
                                        while($rows = mysqli_fetch_assoc($resActiveRide))
                                        {
                                            $bookingid = $rows['id'];
                                            $stu_id = $rows['stu_id'];
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $date ?></td>
                                            <td><?php echo $time ?></td>
                                            <td><span style="background:#d4d700; border-radius:50px; color: #FFF; padding: 1px 5px;"> <b>On Ride</b> </span></td>
