...
<head>
    ...
    <title>Today Rides - WeCycle</title>
            ...
            <nav class="navbar navbar-light">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="todayrides.php" class="dropdown-item active"><i class="far fa-file-alt me-2"></i>Today Rides</a>
                ...
                <div class="casebox bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php
                                $qryUpcomingRide = "SELECT * FROM tbl_rides WHERE DATE(date_time) = CURDATE()";
