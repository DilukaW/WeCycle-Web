...
<head>
    ...
    <title>Admin Users - WeCycle</title>
...
<body>
    ...
    <div class="container-xxl position-relative bg-none d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Admin Users Start -->
            <div class="add row">
                <a class="addbutton btn btn-sm btn-primary" href="add-admin.php">Add User</a>
            </div>
            <div class="container-fluid pt-4 px-4">
                <div class="casebox bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0" style="padding-top: 30px;">Users</h6>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="tth text-dark">
                                    ...
                                    <th class="dbtn" scope="col">Delete</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php
                                $qryAdminDetail = "SELECT * FROM tbl_user";
                                $resAdminDetail = mysqli_query($conn, $qryAdminDetail);
                                if(mysqli_num_rows($resAdminDetail)>0)
                                {
                                    while($rows = mysqli_fetch_assoc($resAdminDetail))
                                    {
                                        $adminId = $rows['usr_id'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dbtn">
                                                <input type="Submit" id="btnDelete" name="btnDelete" class="btn deletebutton" data-bs-toggle="modal" data-bs-target="#exampleModal" value="Delete" >
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                if(isset($_POST['btnDelete']) AND $_SESSION['SuperAdmin'] =="SuperAdmin")
                                {
                                    $qryDelete = "DELETE FROM tbl_user WHERE usr_id='$adminId'";
                                    $resDelete = mysqli_query($conn, $qryDelete);
                                }
                                ?>
