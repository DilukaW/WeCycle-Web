    ...
    <div class="container-xxl position-relative bg-none d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            ...
            <nav class="navbar navbar-light">
                    ...
                    <a href="map.php" class="nav-item nav-link active"><i class="fa fa-map me-2"></i>Map</a>                
                ...
                <div class="row g-4">
                    <div >
                        <div class="bg-light rounded h-100 p-10">
                            ...
                            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15846.303361252902!2d80.0415729!3d6.8213291!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x546c34cd99f6f488!2sNSBM%20Green%20University!5e0!3m2!1sen!2slk!4v1652353776351!5m2!1sen!2slk"
                            frameborder="0" style="height: 500px; width: 100%; padding: 20px 20px 15px 20px;" allowfullscreen="" aria-hidden="false"
                            tabindex="0"></iframe>
                        </div>
                    </div>
                </div>
