...
<head>
    ...
    <title>Upcoming Rides - WeCycle</title>
            ...
            <nav class="navbar navbar-light">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="upcoming-rides.php" class="dropdown-item active"><i class="far fa-file-alt me-2"></i>Upcoming Rides</a>
                ...
                <div class="casebox bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php
                                $qryUpcomingRide = "SELECT * FROM tbl_rides WHERE status='Upcoming'";
                                $resUpcomingRide = mysqli_query($conn, $qryUpcomingRide);
                                if(mysqli_num_rows($resUpcomingRide)>0)
                                {
                                    while($rows = mysqli_fetch_assoc($resUpcomingRide))
                                    {
                                        $bookingid = $rows['id'];
                                        $stu_id = $rows['stu_id'];
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $date ?></td>
                                        <td><?php echo $time ?></td>
                                        <td><span style="background:#ff9c1a; border-radius:50px; color: #FFF; padding: 1px 5px;"> <b>Upcoming</b> </span></td>
