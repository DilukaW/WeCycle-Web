...
<head>
    ...
    <title>Completed Rides - WeCycle</title>
            ...
            <nav class="navbar navbar-light">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="Completed-rides.php" class="dropdown-item active"><i class="far fa-file-alt me-2"></i>Completed Rides</a>
                ...
                <div class="casebox bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php
                                $qrtCompletedRide = "SELECT * FROM tbl_rides WHERE status='Completed'";
                                $resCompletedRide = mysqli_query($conn, $qrtCompletedRide);
                                if(mysqli_num_rows($resCompletedRide)>0)
                                {
                                    while($rows = mysqli_fetch_assoc($resCompletedRide))
                                    {
                                        $bookingid = $rows['id'];
                                        $stu_id = $rows['stu_id'];
                                        $bicycleid = $rows['bicycle_id'];
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $date ?></td>
                                        <td><?php echo $time ?></td>
                                        <td><span style="background:#39B54A; border-radius:50px; color: #FFF; padding: 1px 5px;"> <b>Completed</b> </span></td>
