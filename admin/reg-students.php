...
<head>
    ...
    <title>Reg Students - WeCycle</title>
                ...
                <div class="casebox bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php
                                $qryStudentDetail = "SELECT * FROM tbl_student";
                                ...
                                if(mysqli_num_rows($resStudentDetail)>0)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sm btn-primary" href="user-details.php?studId=<?php echo $studId ?>">Details</a></td>
                                    </tr>
